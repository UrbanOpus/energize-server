...
module.exports = function (app, passport) {
    ...
    */
    ...
    app.post('/api/add_gas', function(req, res) {
        console.log(req.body);
        var token = req.body.token;
        var accountid = req.body.accountid;
        var password = req.body.pass;
        Account.add_gas_account(token, accountid, password, function(err, success) {
            if(!err && success) {
                res.json({
                    "ok":success
                });
    ...
    app.post('/api/add_electric', function(req, res) {
        console.log(req.body);
        var token = req.body.token;
        var accountid = req.body.accountid;
        var password = req.body.pass;
        Account.add_electric_account(token, accountid, password, function(err, success) {
            if(!err && success) {
                res.json({
                    "ok":success
                });
